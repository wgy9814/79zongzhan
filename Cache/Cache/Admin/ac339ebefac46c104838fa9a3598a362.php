...
</style><div id="Profile" class="list"><h1><b><?php echo L(Profile_info);?></b><span>Profile&nbsp; Info</span></h1><ul><?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span><?php echo L($key);?>:</span><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><!--
	<div id="sitestats" ><h1><b><?php echo L(Site_Stats);?></b><span>Site&nbsp; Stats</span></h1><div><ul><?php if(is_array($moduledata)): $i = 0; $__LIST__ = $moduledata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><b><?php echo ($v[title]); ?></b><br><span><?php echo ($v[counts]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li><li><b></b><span></span></li></ul></div></div>
	--><div id="system"  class="list"><h1><b><?php echo L(system_info);?></b><span>System&nbsp; Info</span></h1><ul><?php if(is_array($server_info)): $i = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span><?php echo L($key);?>:</span><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><!--
 	<div id="yourphpnews" class="list"><h1><b><?php echo L(Help_News);?></b><span>Yourphp&nbsp;Update</span></h1><ul><?php if(is_array($yourphp_info)): $i = 0; $__LIST__ = $yourphp_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span><?php echo L($key);?>:</span><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?><li></li><li></li></ul></div><script type="text/javascript" src="http://www.yourphp.cn/index.php?m=Js&a=index&type=license&host=<?php echo ($_SERVER['SERVER_NAME']); ?>&key=<?php echo YP_KEY;?>&ver=<?php echo VERSION;?>&time=<?php echo UPDATETIME;?>"></script>
--></body></html>